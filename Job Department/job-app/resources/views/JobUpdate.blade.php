...
@section('content')
    ...
    <div class="container">
        ...
        <div class="main">
            <form action="{{ url('student/' .$job->id) }}" method="post">
                {!! csrf_field() !!}
                <center>
                    <table>
                        @method("PATCH")
                        <tr>
                            <th>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->jobtitle }}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">PUBLISH DATE</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->P_date }}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">SUMMARY</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->Summary }}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">REQUIREMENTS</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->Requirements }}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">IMAGE</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->imageadd }}" required>
                                </div>
                            </th>
                            <th>
                                <div class="mb-5">
                                    ...
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->NOV}}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">CLOSHING DATE</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->C_date}}" required>
                                </div>
                                <div class="mb-5">
                                    ...
                                    < <input class="form-control form-control-lg" id="exampleFormControlInput1"
                                        name="" placeholder="" value="{{ $job->Duties}}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">REQUIRED DOCUMENTS</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->Req_Doc}}" required>
                                </div>
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="form-label">STATUS</label>
                                    <input class="form-control form-control-lg" id="exampleFormControlInput1" name=""
                                        placeholder="" value="{{ $job->done}}" required>
                                </div>
                            </th>
                        </tr>
                        @stop
