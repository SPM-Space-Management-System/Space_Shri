...
@section('content')
    ...
    <form method="post" action="{{ route('projectinsert.store') }}" role="form">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-title">Rocket Project Details...</h1>
                </div>
                <div class="img-project">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="700" height="400"
                        viewBox="0 0 855.15669 581.90681" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e6e6e6" />
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#3f3d56" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#3f3d56" />
                        <rect x="356.21949" y="515.39594" width="64.47382" height="217.68039"
                            transform="translate(-194.26833 -166.59855) rotate(-1.58175)" fill="#e6e6e6" />
                        <polygon points="242.126 333.079 229.737 366.828 229.748 520.587 244.844 524.916 242.126 333.079"
                            fill="#ccc" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e48f15" />
                        <polygon points="183.151 465.568 144.192 493.088 137.386 555.138 182.834 539.953 183.151 465.568"
                            fill="#e6e6e6" />
                        <rect x="480.62986" y="512.731" width="64.47382" height="217.68039"
                            transform="translate(-194.14737 -163.16544) rotate(-1.58175)" fill="#e6e6e6" />
                        <polygon points="301.996 333.806 315.257 367.222 319.236 520.93 304.257 525.649 301.996 333.806"
                            fill="#ccc" />
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e48f15" />
                        <polygon points="368.086 449.662 405.749 478.93 409.715 541.227 365.009 523.983 368.086 449.662"
                            fill="#e6e6e6" />
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#f2f2f2" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#3f3d56" />
                        <rect x="415.4532" y="291.40111" width="64.47382" height="440.01582"
                            transform="translate(-191.13137 -165.0065) rotate(-1.58175)" fill="#e6e6e6" />
                        <polyline
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e6e6e6" />
                        <polygon points="676.847 481.363 669.62 489.238 635.806 465.112 646.471 453.489 676.847 481.363"
                            fill="#a0616a" />
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#2f2e41" />
                        <polygon points="714.287 559.924 704.06 563.031 687.21 525.063 702.304 520.478 714.287 559.924"
                            fill="#a0616a" />
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#2f2e41" />
                        <path id="ad16ec3e-8c70-4d69-a6df-f9bf45b483f6-44" data-name="Path 17"
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e48f15" />
                        <path id="ef5568b9-6037-4ec0-9cfc-fa22633e4b80-45" data-name="Path 18"
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#a0616a" />
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#e48f15" />
                        <circle id="af7fa85c-211d-4c02-a612-cf38cfa53f1c" data-name="Ellipse 5" cx="672.12801"
                            cy="202.13103" r="21.43064" fill="#a0616a" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" fill="#ccc" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" opacity="0.17" style="isolation:isolate" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.18543 -177.55905)" opacity="0.17" style="isolation:isolate" />
                        <polygon points="519.409 269.531 530.939 285.603 543.881 347.068 537.865 352.316 519.409 269.531"
                            fill="#e48f15" />
                        <path
            ...
            <section>
                <div class="form-group">
                    ...
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('fcost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('ecost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('fucost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('oxcost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('pcost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('ncost') }}</div>
                    </div>
                    <div class="mb-5">
                        ...
                        <br>
                        <div class="text-danger">{{ $errors->first('ocost') }}</div>
                    </div>
                </div>
            </section>
        </div>
            ...
            <div class="btn-group">
                <p><input type="submit" title="Click this button to save the entered data."
                    ...
                    <a title="Click this button to view the entered data." class="btn btn-warning btn-lg btn-block"
                        href="{{ route('projectview') }}" role="button">VIEW
                        DETAILS</a>
                </p>
            </div>
        </div>
