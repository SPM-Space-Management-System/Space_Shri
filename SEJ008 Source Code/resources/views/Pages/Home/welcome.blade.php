...
@section('content')
    ...
    <div class="cont">
        <div class="cards">
            ...
            <div class="content">
                <div class="details">
                    <h2>Waruni Bhagya<br><span>Article Department</span></h2>
        ...
        <div class="cards">
            ...
            <div class="content">
                <div class="details">
                    <h2>RCP Rajapaksha<br><span>Rocket Department</span></h2>
                    <ul class="social_icons">
                        <li><a href="#">
                                <ion-icon name="logo-facebook"></ion-icon>
                            </a></li>
        ...
        <div class="cards">
            <div class="personBx">
                <img src="chandima1.jpg">
            </div>
            <div class="content">
                <div class="details">
                    <h2>Sanju Chandima<br><span>Operation Department</span></h2>
                    <ul class="social_icons">
                        <li><a href="#">
                                <ion-icon name="logo-facebook"></ion-icon>
                            </a></li>
        ...
        <div class="cards">
            ...
            <div class="content">
                <div class="details">
                    <h2>Dasunika Sewwandi<br><span>Jobs & Career Department</span></h2>
                    <ul class="social_icons">
                        <li><a href="#">
                                <ion-icon name="logo-facebook"></ion-icon>
                            </a></li>
...
@push('css')
    <style>
        ...
        .cont .cards:hover .personBx {
            transform: translateY(30px) scale(0.5);
        }

        .cont .cards .personBx img {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        .cont .cards:hover .content {
            transform: translateY(0);
        }

        .cont .cards .content .details {
            display: flex;
            justify-content: center;
            align-items: center;
        ...
        .cont .cards .content .details h2 {
            color: #fff;
            font-size: 1.4em;
            font-weight: 500;
        }

        .cont .cards .content .details h2 span {
            font-size: 0.8em;
            font-weight: 400;
            color: #03a9f4;
        }
